...
- **BREAKING**：既有依賴預設 CORS 連 `your-deployment.example.com` 的部署需顯式設 `WENJI_CORS_ORIGINS`。已驗證主公的 logos production（Oracle VPS、`/home/ubuntu/logos`、nohup uvicorn :8001）已 inline 設 `WENJI_CORS_ORIGINS=https://your-deployment.example.com`，BREAKING 對它無實質影響
