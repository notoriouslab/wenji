...
- **THEN** it returns zero hits (CHANGELOG and openspec history are outside the audited paths; the generic-word production identifiers listed in the requirement stay untouched and are not matched by this symbol set)
