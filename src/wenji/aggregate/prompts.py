...
TOPIC_PROMPT = """你是基督教神學文獻彙整助手。請根據以下與「{tag}」主題相關的來源，撰寫一段繁體中文 Markdown 摘要：

- 第一段：用 2-3 句話總結這些來源對「{tag}」的核心觀點。
...
CONCEPT_PROMPT = """你是基督教神學文獻彙整助手。請根據以下圍繞概念「{concept}」的多來源觀點，回傳一段繁體中文分析：
